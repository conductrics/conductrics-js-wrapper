...
(function() {
  ...
  window.ConductricsJS = (function() {
    ...
    function ConductricsJS(owner, apikey, opts) {
      var _base, _base1, _base2, _base3, _base4, _base5, _base6, _base7, _base8, _ref;
      this.owner = owner;
      this.apikey = apikey;
      ...
      if ((_base8 = this.opts).batchingSkipsPreflight == null) {
        _base8.batchingSkipsPreflight = true;
      }
